...
// File: contracts/MineNftGweiItem.sol
...
contract MineNftGweiItem is MineNftAccessControl, ERC721 {
    ...
    function mint(bytes32 hash, string memory tokenURI)
        ...
        returns (uint256)
    {
        require(hashes[hash] == 0, "MineNftGweiItem: Already registered!");
        require(paintings < 1000, "MineNftGweiItem: Gwei is retired!");

        uint256 minAmount = getMinimumAmount();
        require(msg.value >= minAmount, "MineNftGweiItem: Invalid Amount");
    ...
    function withdraw(uint256 amount) public returns (bool) {
        require(msg.sender == owner, "MineNftGweiItem: Invalid msg.sender");
