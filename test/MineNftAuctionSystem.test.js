...
const MineNftAuctionSystem = artifacts.require('MineNftAuctionSystem');
...
contract('MineNftAuctionSystem', accounts => {
  ...
  it('should send bids', async () => {
    ...
    try
    {
      ...
      expect(e.reason).to.be.equal('MineNftAuctionSystem:LOW_BID_MINIMUM_AMOUNT');
    }
    ...
    try
    {
      ...
      expect(e.reason).to.be.equal('MineNftAuctionSystem:LOW_BID');
    }
  ...
  it('should end an auction', async () => {
    ...
    try {
      ...
      expect(e.reason).to.be.equal('MineNftAuctionSystem:NOT_YET_ENDED');
    }
