...
import "./MineNftAccessControl.sol";
import "./MineNftToken.sol";

import "./IMineNftItem.sol";

contract MineNftGweiItem is
    IMineNftItem,
    ...
    ERC721
{
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        require(
            canSetSpecialPlaces,
            "MineNftGweiItem:SPCIAL_PLACES_CLOSED"
        );
    ...
    function mint(
        ...
        require(
            ...
            "MineNftGweiItem:ONLY_WHITELISTED!"
        );

        bytes32 hash = hashData(_inspiration, _text, _useRandom, _probability);

        require(hashes[hash] == 0, "MineNftGweiItem:ALREADY_REGISTERED");
        require(totalSupply() < 1000, "MineNftGweiItem:GWEI_IS_RETIRED");
        ...
        require(
            ...
            "MineNftGweiItem:PRICE_HAS_CHANGED"
        );
    ...
    function updatePlace(uint256 _tokenId, uint8 _place) public {
        require(
            ...
            "MineNftGweiItem:FORBIDEN_PLACE!"
        );
    ...
    function updateTokenURI(
        ...
        require(tokenOwner == msg.sender, "MineNftGweiItem:INVALID_SENDER");

        require(
            validator != address(0),
            "MineNftGweiItem:INVALID_SIGNATURE"
        );
        require(
            hasRole(VALIDATOR_ROLE, validator),
            "MineNftGweiItem:INVALID_VALIDATOR"
        );
