...
contract('MineNftGweiItem', accounts => {
  ...
  it('should fail to update a token URI based on an invalid validator', async () => {
    ...
    try {
      ...
      expect(e.reason).to.be.equal('MineNftGweiItem:INVALID_VALIDATOR', 'fail to check failure');
    }
  });
  ...
  it('should fail to update a token URI based on an invalid signature', async () => {
    ...
    try {
      ...
      expect(e.reason).to.be.equal('MineNftGweiItem:INVALID_SIGNATURE', 'fail to check failure');
    }
  });
  ...
  it('should fail to update a token URI based on an invalid sender', async () => {
    ...
    try {
      ...
      expect(e.reason).to.be.equal('MineNftGweiItem:INVALID_SENDER', 'fail to check failure');
    }
  });
