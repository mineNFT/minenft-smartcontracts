...
import "./MineNftAuctionSystemAccessControl.sol";

contract MineNftAuctionSystem is
    MineNftAuctionSystemAccessControl,
    ERC1155Holder,
    ERC721Holder
{
    ...
    function setup(
        ...
        require(
            ...
            "MineNftAuctionSystem:INVALID_AUCTION_FEE"
        );
        require(
            _bidFeeRate <= ONE_HUNDRED_PERCENT,
            "MineNftAuctionSystem:INVALID_BID_FEE"
        );
    ...
    function createAuction(
        ...
        if (_tokenType == TokenType.ERC721) {
            ...
            require(
                ...
                "MineNftAuctionSystem:ERC721_NOT_APPROVED"
            );
            ...
            require(
                token.isApprovedForAll(msg.sender, address(this)),
                "MineNftAuctionSystem:ERC1155_NOT_APPROVED"
            );
        ...
        require(
            ...
            "MineNftAuctionSystem:INVALID_TIME_STAMP"
        );

        require(
            allowedTokensMapping[_tokenPriceAddress],
            "MineNftAuctionSystem:INVALID_TOKEN_PRICE_ADDRESS"
        );

        require(
            _bidBackFee <= ONE_HUNDRED_PERCENT,
            "MineNftAuctionSystem:INVALID_BID_BACK_PERCENTUAL"
        );
    ...
    function bid(uint256 _auctionId, uint256 _amount) public {
        ...
        require(
            ...
            "MineNftAuctionSystem:AUCTION_ENDED"
        );

        require(
            _amount > auctionInfo.highestBid,
            "MineNftAuctionSystem:LOW_BID"
        );

        require(
            _amount >= auctionInfo.minimumAmount,
            "MineNftAuctionSystem:LOW_BID_MINIMUM_AMOUNT"
        );
        ...
        require(
            ...
            "MineNftAuctionSystem:FAIL_TO_TRANSFER_BID_AMOUNT"
        );

        require(
            tokenPrice.transfer(addressFee, feeAmount),
            "MineNftAuctionSystem:FAIL_TO_TRANSFER_FEE_AMOUNT"
        );
    ...
    function withdraw(uint256 _auctionId) public {
        ...
        if (amount > 0) {
            ...
            require(
                ...
                "MineNftAuctionSystem:FAIL_TO_WITHDRAW"
            );
        } else {
            revert("MineNftAuctionSystem:NOTHING_TO_WITHDRAW");
        }
    }
    ...
    function endAction(uint256 _auctionId) public {
        ...
        require(
            getNow() >= auctionInfo.auctionEndTime,
            "MineNftAuctionSystem:NOT_YET_ENDED"
        );
        require(!auctionInfo.ended, "MineNftAuctionSystem:ALREADY_ENDED");
        ...
        require(
            ...
            "MineNftAuctionSystem:FAIL_TO_PAY_BENEFICIARY"
        );

        require(
            tokenPrice.transfer(addressFee, feeAmount),
            "MineNftAuctionSystem:FAIL_TO_PAY_DEVADDRESS"
        );
