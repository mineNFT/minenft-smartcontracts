...
// File: contracts/MineNftAccessControl.sol

// SPDX-License-Identifier: GPL-v3
pragma solidity >=0.6.0;


abstract contract MineNftAccessControl is AccessControl {
    ...
    modifier onlyRole(bytes32 role) {
        require(
            ...
            "MineNftAccessControl: INVALID_ROLE"
        );
        _;
    }
}
...
// File: contracts/MineNftToken.sol
...
contract MineNftToken is
    MineNftAccessControl,
    ERC20Snapshot,
    ERC20Pausable,
    ERC20Burnable
{
...
// File: contracts/IMineNftItem.sol
...
// File: contracts/MineNftExpressionsItem.sol
...
contract MineNftExpressionsItem is
    IMineNftItem,
    MineNftAccessControl,
    ERC721
{
    ...
    function getName(uint256 _mineNftId)
        ...
        returns (string memory)
    {
        require(_mineNftId == 1, "MineNftExpressionsItem:INVALID_ID");
        return "Expressions";
    }
    ...
    function getCurrentAmount(uint256 _mineNftId, uint256 _supply)
        public
        view
        override
        returns (uint256)
    ...
    function mint(
        ...
        require(
            hashes[hash] == 0,
            "MineNftExpressionsItem:ALREADY_REGISTERED"
        );
        require(totalSupply() < 750, "MineNftExpressionsItem:IS_RETIRED");

        uint256 amount = getCurrentAmount(totalSupply());

        require(
            amount <= _expectedAmount,
            "MineNftExpressionsItem:PRICE_HAS_CHANGED"
        );
        require(
            msg.value >= amount,
            "MineNftExpressionsItem:INVALID_AMOUNT"
        );
    ...
    function updateTokenURI(
        ...
        require(
            ...
            "MineNftExpressionsItem:INVALID_SENDER"
        );

        require(
            validator != address(0),
            "MineNftExpressionsItem:INVALID_SIGNATURE"
        );
        require(
            hasRole(VALIDATOR_ROLE, validator),
            "MineNftExpressionsItem:INVALID_VALIDATOR"
        );
